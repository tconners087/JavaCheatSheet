...
\subsection{Fields}
\begin{itemize*}
	\item \ltxt{EMPTY$\_$LIST}
	\item[] \cmnt{// Modifier and Type: static List}
	\item[] \cmnt{// The empty list (immutable).}
	\item \ltxt{EMPTY$\_$MAP}
	\item[] \cmnt{// Modifier and Type: static Map}
	\item[] \cmnt{// The empty map (immutable).}
	\item \ltxt{EMPTY$\_$SET}
	\item[] \cmnt{// Modifier and Type: static Set}
	\item[] \cmnt{// The empty set (immutable).}
\end{itemize*}

%\item[] \cmnt{// }
%TODO: Sorting Algorithms, Greedy Algorithms, Searches, Dynamic Programming, Graphs, Trees, Recursion, Bubble Sort, Comparator, Counting Sort, Binary Search, BST
