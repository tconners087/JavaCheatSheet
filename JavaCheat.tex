...
\cmnt{// The above two signatures are overloaded where the first and fourth parameters (the array and the key) can have the following data-types:}
\begin{itemize*}
	\item int
	\item short
	\item char
...
\end{itemize*}
\cmnt{// The above to signature is overloaded where both parameters can be arrays of type:}
\begin{itemize*}
	\item int
	\item short
	\item char
...
\end{itemize*}
\cmnt{// The above two signatures are overloaded where the array and the `val' can have the following data-types:}
\begin{itemize*}
	\item int
	\item short
	\item char
...
\cmnt{// The above signature where the return type is primitive is overloaded where the array passed and returned can have the following data-types:}
\begin{itemize*}
	\item int
	\item byte
	\item short
...
%\item[] \cmnt{// }
%TODO: Vectors, Arrays, ArrayList, List, StringTokenizer, Sorting Algorithms, Greedy Algorithms, Searches, Dynamic Programming, Stacks, Queues, Graphs, Trees, Linked Lists, Recursion
